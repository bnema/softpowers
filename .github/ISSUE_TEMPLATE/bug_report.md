...
## Is this a Softpowers issue or a platform issue?
<!-- Softpowers is a plugin. Some reported "bugs" are actually issues
     in the underlying platform or model. If you're not sure, try
     reproducing without Softpowers installed.

     If the problem persists without Softpowers, file the issue with
     your platform instead. -->

- [ ] I confirmed this issue does not occur without Softpowers installed
