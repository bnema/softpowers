...
8. Once workspace selection is settled and before dispatching any implementer subagent, ask whether to start the local reviewer server in that workspace so the user can review while you work.
