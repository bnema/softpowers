...
> **For agentic workers:** REQUIRED: Use softpowers:subagent-driven-development (if subagents available) or softpowers:executing-plans to implement this plan.
...
**Spec:** docs/softpowers/specs/2026-01-22-document-review-system-design.md
...
**Dispatch after:** Spec document is written to docs/softpowers/specs/
...
```markdown
> **For agentic workers:** REQUIRED: Use softpowers:subagent-driven-development (if subagents available) or softpowers:executing-plans to implement this plan. Tasks and steps use checkbox (`- [ ]`) syntax for tracking.
```
