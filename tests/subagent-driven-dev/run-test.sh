...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/softpowers
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/softpowers-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using softpowers:subagent-driven-development. The plan is at: $PLAN_PATH"
